						...
						<div class="row">
							<div class="col-md-3 bg-success mx-2" style="height: 130px;">
								<div class="col-md-12">
									<div class="row">
										...
										<div class="col-md-4">
											<a href="admin.php"><i class=" fa fa-sharp fa-solid fa-user-tie fa-3x my-4" style="color: white;"></i></a>
										</div>
							...
							<div class="col-md-3 bg-info mx-2" style="height: 130px;">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<a href="doctor.php"><i class=" fa fa-sharp fa-solid fa-user-tie fa-3x my-4" style="color: white;"></i></a>
										</div>
                            ...
                            <div class="col-md-3 bg-warning mx-2" style="height: 130px;">
                            	<div class="col-md-12">
									<div class="row">
										...
										<div class="col-md-4">
											<a href="patient.php"><i class=" fa fa-sharp fa-solid fa-bed fa-3x my-4" style="color: white;"></i></a>
										</div>
							...
							<div class="col-md-3 bg-danger mx-2 my-2" style="height: 130px;">
								<div class="col-md-12">
									<div class="row">
										...
										<div class="col-md-4">
											<a href="report.php"><i class=" fa fa-sharp fa-regular fa-flag fa-3x my-4" style="color: white;"></i></a>
										</div>
							...
							<div class="col-md-3 bg-warning mx-2 my-2" style="height: 130px;">
								<div class="col-md-12">
									<div class="row">
										...
										<div class="col-md-4">
											<a href="job_request.php"><i class=" fa fa-sharp fa-light fa-pen fa-3x my-4" style="color: white;"></i></a>
										</div>
							...
							<div class="col-md-3 bg-success mx-2 my-2" style="height: 130px;">
								<div class="col-md-12">
									<div class="row">
										...
										<div class="col-md-4">
											<a href="income.php"><i class=" fa fa-regular fa-money-bill fa-3x my-4" style="color: white;"></i></a>
										</div>
